        ...
        namespace Effects
        {
            ...
            public abstract class ParticleAffector : MonoBehaviour
            {
                ...
                protected virtual void LateUpdate()
                {
                    ...
                    else if (this.particleSystems.Length > 0)
                    {
                    ...
                    for (int i = 0; i < particleSystems.Count; i++)
                    {
                        ...
                        Vector3 particleSystemPosition = particleSystem.simulationSpace ==
                        ...
                        for (int j = 0; j < particleCount; j++)
                        {
                            ...
                            parameters.particlePosition = particleSystemPosition + particle.position;
